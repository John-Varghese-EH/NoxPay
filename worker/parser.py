...
class ParserRegistry:
    ...
    @classmethod
    def detect(cls, email_body: str) -> Optional[BankParser]:
    ...
    @classmethod
    def process(cls, email_body: str) -> Optional[ParsedTransaction]:
        """Iterates through parsers and returns the first valid ParsedTransaction."""
        for parser in cls.PARSERS:
            if parser.can_parse(email_body):
