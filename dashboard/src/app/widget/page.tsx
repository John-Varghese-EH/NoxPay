...
export default async function WidgetPage({ searchParams }: { searchParams: { intent?: string } }) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-transparent">
            ...
            <div className="w-full h-full min-h-[500px] flex flex-col bg-slate-950 border border-slate-800 rounded-2xl shadow-xl overflow-hidden animate-in fade-in duration-500 rounded-xl">
